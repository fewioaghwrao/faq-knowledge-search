      ...
      <div className="relative p-6">
        ...
        <div className="relative">
                        ...
                        >
                          ...
                          <td className="px-5 py-4">
                            <select
                              ...
                              className="rounded-xl border border-white/10 bg-slate-800 px-3 py-2 text-sm text-white outline-none transition focus:border-blue-400 focus:ring-2 focus:ring-blue-500/20 disabled:cursor-not-allowed disabled:opacity-60"
                            >
          ...
          <div className="mt-4 text-xs text-slate-500">
            ※ 自分自身のAdminロールを変更すると、管理画面へアクセスできなくなる可能性があります。
          </div>
        </div>
      </div>
    </div>
